<template>
	<div>
		...
		>
			<!-- Nav Header -->
			<!-- kontent -->
			<h1 class="p-3 text-center my-5">PLAN</h1>
			<div class="d-flex flex-lg-row">
				...
				>
					<div
						class="box-question card-body rounded-1 bg-body-secondary mx-auto p-2"
					>
						<div class="wrapper d-flex flex-column gap-2 my-3">
							<div class="tittle text-center">
								<h2>Penilaian Lapangan</h2>
							</div>
							<form class="form-floating">
								...
								/>
								<label for="floatingInputValue">Name Juri</label>
							</form>
							...
							<div class="form-floating">
								...
								>
									<option disabled>Team List</option>
